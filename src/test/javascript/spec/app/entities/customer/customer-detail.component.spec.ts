...
import { QuyenbeoAdminTestModule } from '../../../test.module';
    ...
    describe('Customer Management Detail Component', () => {
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [QuyenbeoAdminTestModule],
        ...
        describe('OnInit', () => {
            ...
            spyOn(service, 'find').and.returnValue(Observable.of(new Customer('aaa')));
            ...
            expect(comp.customer).toEqual(jasmine.objectContaining({id: 'aaa'}));
            });
        });
    });
